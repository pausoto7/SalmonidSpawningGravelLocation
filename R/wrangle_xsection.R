...
xsection_raw <- read_xls("tabular data/points_with_elev_BWK_v2.xls") 
...
writeRaster(dem_utm, "dem_utm.tif", overwrite = TRUE)
...
st_write(pts_utm, "pour_points.shp", append = FALSE)
